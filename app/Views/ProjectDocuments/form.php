    ...
    <div class="col-12 col-md-9 mt-1 pt-3 pb-3 bg-white from-wrapper">
      <div class="container">
        ...
        <form id="documentForm" action="/documents/<?= $action ?>" method="post">
          ...
          <ul class="nav nav-tabs nav-justified mb-3 mt-2" id="myTab" role="tablist">
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" id="section-tab" data-toggle="tab" href="#section" role="tab" aria-controls="section"
